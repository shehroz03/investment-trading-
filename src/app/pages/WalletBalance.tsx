...
import { Wallet, ArrowDownToLine, ArrowUpFromLine, Lock, Clock } from "lucide-react";
...
export default function WalletBalance() {
  ...
  const balances = [
    ...
    { label: "Pending Balance", value: wallet.pending, icon: Clock, color: "text-amber-400 bg-amber-500/15" },
    { label: "Locked Balance", value: wallet.locked, icon: Lock, color: "text-slate-400 bg-slate-500/15" },
  ];
